document.addEventListener('DOMContentLoaded', () => {
  ...
  if (quickCheck) quickCheck.addEventListener('submit', (event) => {
    ...
    quickCheck.querySelector('.inline-feedback').textContent = !value ? 'Selecciona una alternativa antes de revisar.' : value === 'b' ? '¡Correcto! El análisis integra factores individuales y contextuales.' : 'Aún no. Considera a la vez al estudiante y las condiciones del contexto.';
  });
